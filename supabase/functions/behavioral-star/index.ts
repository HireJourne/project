...
serve(async (req) => {
  ...
  try {
        ...
        messages: [
          {
            ...
            Generate 15 behavioral interview questions with STAR-I format answers that:
            ...
            5. Connect past experiences to future role
    ...
    if (!openaiResponse.ok) {
      ...
      throw new Error(error.error?.message || 'Failed to generate STAR answers');
    }
